...
const Contactus = () => {
    ...
    const handlesubmit = () =>{
        window.open(`bijay.gautam1501@gmail.com?subject=Sample&body=${body}`)
    }
    return (
            ...
            <div className="showAdrss">
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3> Address</h3>
                        <p>Civil Mall 2nd Floor, Kamalpokhari, Kathmandu, 44100 Nepal </p>
                    </div>
                </div>
                    <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Lets Talk</h3>
                        <p className="infoCtn">+977 1234567</p>
                    </div>
                </div>
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Sale Support</h3>
                        <p className="infoCtn">kapdabazar@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
